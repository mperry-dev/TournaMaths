        ...
        http
            ...
            .headers(headers ->
                headers.xssProtection(
                        ...
                        cspc -> cspc.policyDirectives(
                            "script-src 'self' cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.16.9/katex.min.js; " + // Allow restricted list of scripts
